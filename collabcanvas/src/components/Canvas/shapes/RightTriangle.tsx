 ...
 * Renders a right triangle with 90° angle at bottom-left
 * 
 * @param props - Right triangle properties
 */
const RightTriangle: React.FC<RightTriangleProps> = ({
  ...
  // Right triangle with 90° angle at bottom-left
  // Bottom-left (right angle), top-left, bottom-right
  const points = [
    0, height,      // Bottom-left (90° angle)
    0, 0,           // Top-left
